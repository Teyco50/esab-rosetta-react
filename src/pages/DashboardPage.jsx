    ...
    <div className="dashboard">
      ...
      <div className="dashboard-container">
        ...
        <div className="kpi-grid">
          <KPICard title="Open Claims"    value={stats.openClaims}   icon="📋" gradient={['#6366f1','#818cf8']} trend={{ positive: true,  percent: 12 }} comparison="vs last period" />
          <KPICard title="Closed Claims"  value={stats.closedClaims} icon="✅" gradient={['#10b981','#34d399']} trend={{ positive: true,  percent: 50 }} comparison="vs last period" />
          <KPICard title="YTD Claims"     value={stats.ytdClaims}    icon="📊" gradient={['#f59e0b','#fbbf24']} trend={{ positive: false, percent: 8  }} comparison="vs last year"   />
          <KPICard title="Active Regions" value={stats.regionCount}  icon="🌍" gradient={['#8b5cf6','#a78bfa']} trend={{ positive: true,  percent: 25 }} comparison="worldwide"      />
        </div>

        {/* Bottom: Map + Status side by side */}
